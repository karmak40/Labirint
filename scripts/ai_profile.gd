...
const STRATEGIES := {
	"balanced": {
		...
		"studies": ["forging", "spears", "archery", "chivalry", "mail", "crossbows"],
		"mix": {"knight": 3.0, "spearman": 2.0, "archer": 2.0, "crossbowman": 1.5},
		"towers": 2, "towers_early": false, "library_after": 3,
		"attack_after": 0.0, "attack_needs": [],
	},
	"rush": {
		"title": "Натиск", "about": "Рано и часто нападает дешёвыми бойцами: копейщики и воины. Башен не строит.",
		"think": 2.0, "hires": 3,
		...
		"studies": ["spears", "forging"],
		"mix": {"spearman": 3.0, "warrior": 2.0, "archer": 1.0},
		"towers": 0, "towers_early": false, "library_after": 5,
		"attack_after": 0.0, "attack_needs": [],
	},
	"turtle": {
		"title": "Оборона", "about": "Сидит за башнями, стрелками и арбалетами. Выходит поздно и большой армией.",
		"think": 2.0, "hires": 2,
		"workers_first": {"wood": 2, "ore": 2}, "workers_full": {"wood": 5, "ore": 3}, "gold_hands": 1,
		"first_wave": 8, "wave_growth": 2, "wave_max": 14, "spent_at": 3,
		"home_guard": 450.0, "counter_share": 0.8,
		"studies": ["archery", "mail", "forging", "crossbows", "spears", "chivalry"],
		"mix": {"crossbowman": 3.0, "archer": 3.0, "spearman": 2.0, "knight": 1.0},
		"towers": 4, "towers_early": true, "library_after": 3,
		"attack_after": 480.0, "attack_needs": [],
	},
	"tech": {
		"title": "Знания", "about": "Копит, строит хозяйство и учится. Идёт в бой рыцарями и арбалетчиками, когда всё изучит.",
		"think": 2.0, "hires": 2,
		...
		"studies": ["forging", "chivalry", "mail", "archery", "crossbows", "spears"],
		"mix": {"knight": 4.0, "crossbowman": 2.0, "archer": 1.0},
		"towers": 1, "towers_early": true, "library_after": 3,
		"attack_after": 0.0, "attack_needs": ["chivalry", "forging"],
	},
}
